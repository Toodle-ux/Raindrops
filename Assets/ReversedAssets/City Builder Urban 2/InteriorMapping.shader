Shader "ReversedInt/InteriorMapping" {
    Properties {
        _Color ("Window Tint", Color) = (1,1,1,1)
    ...
    SubShader {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
            ...
            o.Smoothness = _Glossiness * mask;
            o.Emission = lerp(col.rgb, texCUBE(_InteriorCubemap, pos.xyz).rgb, mask) * (mask * _Color);
            o.Alpha = 1.0;
        }
        ENDCG
    }
